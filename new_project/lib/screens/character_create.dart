 ...
 void _cleanRacialControllers(){
  ...
  void createRecord(String name, race, characterClass) async {
    ...
    .add({
      ...
      'FORTITUDE': _modifier(stringSum(conController.text, racialCon.text)) + _characterClass['fortitude'],
      'REFLEX' : _modifier(stringSum(dexController.text, racialDex.text)) + _characterClass['reflex'],
      'WILL' : _modifier(stringSum(wisController.text, racialWis.text)) + _characterClass['will'],
